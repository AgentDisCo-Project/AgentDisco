...
class NoteSummary:
    def __init__(
        ...
        system_template_file: str = "NoteSummary.jinja2"
    ):
    ...
    def get_system_prompt(self):
        template_vars = {
            ...
            'has_images': self.use_note_modality in ("one_image", "all_images"),
            'query_has_images': self.use_query_modality == "both"
        }
    ...
    async def act(
        self,
        input_dict: dict,
        input_key: str = "selected_search_results",
