"""
This module contains the ToolInvoker component. The ToolInvoker component is used to invoke tools based on prepared tool
calls and return the results as a list of ChatMessage objects. The component is provided with a list of available tools
at initialization and processes a list of ChatMessage objects containing tool calls at runtime.
This is a direct copy of
https://github.com/deepset-ai/haystack-experimental/blob/main/haystack_experimental/components/tools/tool_invoker.py
"""
...
from allin_llmflow.dataclasses import ChatMessage, ToolCall
from allin_llmflow.dataclasses.tool import Tool, ToolInvocationError, deserialize_tools_inplace
